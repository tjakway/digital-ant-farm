...
CMAKE_FLTK_OPTIONS="-DOPTION_BUILD_EXAMPLES=OFF -DOPTION_USE_SYSTEM_LIBJPEG=OFF -DOPTION_USE_SYSTEM_ZLIB=OFF -DOPTION_USE_SYSTEM_LIBPNG=OFF"

cmake -v "$CMAKE_FLTK_OPTIONS" "$FLTK_SOURCE_DIR"
make
